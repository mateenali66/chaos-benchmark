...
resource "aws_eks_addon" "vpc_cni" {
  ...
  service_account_role_arn    = var.vpc_cni_role_arn != "" ? var.vpc_cni_role_arn : aws_iam_role.vpc_cni[0].arn
...
resource "aws_eks_addon" "ebs_csi" {
  ...
  resolve_conflicts_on_create = "OVERWRITE"
  resolve_conflicts_on_update = "OVERWRITE"
  service_account_role_arn    = var.ebs_csi_role_arn != "" ? var.ebs_csi_role_arn : aws_iam_role.ebs_csi[0].arn
